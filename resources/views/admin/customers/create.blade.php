            ...
            <form id="customerCreateForm">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="customerName" class="form-control" placeholder="e.g. John Doe" maxlength="255" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="customerEmail">Email <span class="text-danger">*</span></label>
                        <input type="email" name="email" id="customerEmail" class="form-control" placeholder="e.g. john@example.com" maxlength="255" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="customerMobile">Mobile <span class="text-danger">*</span></label>
                        <input type="text" name="mobile" id="customerMobile" class="form-control" placeholder="e.g. 123-456-7890" maxlength="255" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="customerAddress">Address <span class="text-danger">*</span></label>
                        <input type="text" name="address" id="customerAddress" class="form-control" placeholder="e.g. 123 Main St" maxlength="255" required>
                    </div>
...
@push('scripts')
    <script>
        async function doCreateCustomer(){
            ...
            let addressValue = document.getElementById('customerAddress').value.trim();
